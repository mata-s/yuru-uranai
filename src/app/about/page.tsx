  ...
  return (
    <main className="p-8 max-w-3xl mx-auto text-gray-800">
      ...
      <section className="mb-6">
        <p className="mb-4">
          「ゆる占い」は、かわいくて個性豊かなキャラクターたちが、あなたの今日のをゆる〜く占ってくれるWebアプリです。
      ...
      <section className="mb-6">
        ...
        <p>
          本サイトではA8.netをはじめとする外部アフィリエイトサービスを通じて広告を掲載することがあります。
          ユーザーの閲覧体験を損なわないよう、広告の表示位置や数には十分配慮しています。
        </p>
        <p className="text-sm text-gray-500 mt-1">
          ※掲載される広告の内容に関しては各アフィリエイトサービスの提供によるものであり、運営側が内容を保証するものではありません。
        </p>
      </section>
